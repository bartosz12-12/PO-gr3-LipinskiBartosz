...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String date = "1999-06-21";
        String date2 = "1994-12-12";
        String date3 = "2000-12-01";
        ...
        Osoba o1 = new Osoba("Mis", ld1);
        Osoba o2 = new Osoba("Kowalski", ld2);
        Osoba o3 = new Osoba("Nowak", ld3);
        Osoba o4 = new Osoba("Kowal", ld2);
        Osoba o5 = new Osoba("Mackiewicz", ld1);
        Osoba o6 = new Osoba("Jaglak", ld1);
